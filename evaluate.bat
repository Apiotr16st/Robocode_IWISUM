...
if exist "%ROBO_DIR%\robots\robot.database" del /F /Q "%ROBO_DIR%\robots\robot.database"
if exist "%ROBO_DIR%\robots\.robotcache" rmdir /S /Q "%ROBO_DIR%\robots\.robotcache"
